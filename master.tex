...
\def \projectauthors     {
  Mads Munk Nielsen \orcidlink{0009-0002-8095-560X} \href{https://www.linkedin.com/in/madsmunknielsen/}{\faLinkedinSquare} \href{https://github.com/MadsMunkNielsen}{\faGithub} \href{https://vbn.aau.dk/da/persons/mads-nielsen}{\includegraphics[height=0.33cm]{incl/pre/ext/Aaulogo.png}} 
}
...
\begin{appendices}
\include{incl/app/AppendixA.tex}
